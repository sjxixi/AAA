...
from .views.devices import (
    ...
    server_create, network_create, storage_create, security_create
)
...
urlpatterns = [
    ...
    path('server/add/', server_create, name='server_create'),
    ...
    path('network/add/', network_create, name='network_create'),
    ...
    path('storage/add/', storage_create, name='storage_create'),
    ...
    path('security/add/', security_create, name='security_create'),
